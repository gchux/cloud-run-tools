...
// copy of [ProxyOutputStream](https://github.com/apache/commons-io/blob/master/src/main/java/org/apache/commons/io/output/ProxyOutputStream.java) at `master`

package dev.chux.gcp.crun.io;
